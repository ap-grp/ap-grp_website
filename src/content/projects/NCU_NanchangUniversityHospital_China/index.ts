...
const project = {
  ...
  description: {
    en:
      "nanchang university hongjiaozhou branch is planned as a 1,000-bed medical campus in nanchang, with a total gross floor area of approximately 166,700 sqm. \n" +
    ...
    zh:
      "南昌大学第二附属医院红角洲分院规划为一座拥有1000张床位的现代化医疗园区，总建筑面积约166,890平方米。\n" +
